...
Example usage: 
python simulation_mutating_phage_niagara.py 170 10000.0 2.3809523809523808e-06 0.3 0.04 0.001 0.02 2e-06 0.5 3.162277660168379e-06 30 0.03 50 20000 10000.0 1
...
def run_simulation_tau(m_init, f, c0, g, B, R, eta, pv, alpha, e, L, mu, theta, max_save, epsilon, gen_max):
    ...
    all_phages = []
    params_array = np.zeros((16, 2), dtype = 'object')
    params_array[:,0] = ["m_init", "f", "c0", "g", "B", "R", "eta", "pv", "alpha", "e", "L", 
                         "mu", "gen_max", "max_save", "epsilon", "theta"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('theta', type=float, default=0, nargs='?',
                        help='phage mutation distance cutoff')
    ...
    num_mutations, t, x, phage_list = run_simulation_tau(m_init, f, c0, g, B, R, eta, pv, alpha, e, L, mu, theta, max_save, epsilon, gen_max)
